...
function SpringIOLevel1({levelNumber, levelName, functionName, state, dispatch}) {
            ...
            {!state.currentLevelLoading && (
                <div className="Questionnaire">
                    ...
                    <div className="Question">
                        ...
                        <Button small block clickHandler={e => sendAnswer(false, true, false, false)}><span className="option">B.</span> Production</Button>
                        <Button small block clickHandler={e => sendAnswer(false, false, true, false)}><span className="option">C.</span> Staging</Button>
                        <Button small block clickHandler={e => sendAnswer(false, false, false, true)}><span className="option">D.</span> Barcelona</Button>
                        </div>
